# MIGRATION UTILITY ONLY - WILL BE DELETED AFTER PRODUCTION MIGRATION
...
class AreaLeaderModel:
    """
    MIGRATION USE ONLY - Area Leader Model for Vancouver Christmas Bird Count

    This is a copy of the original AreaLeaderModel used only by migration utilities.
    After the production database migration is complete, this file and the migration
    utilities should be deleted as the application now uses single-table design.
